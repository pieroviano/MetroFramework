...
// Test assemblies. They are signed with the same key so that the friend
// declarations resolve for a strong-named assembly.
[assembly: InternalsVisibleTo(MetroFramework.AssemblyRef.MetroFrameworkTestsIVT)]
[assembly: InternalsVisibleTo(MetroFramework.AssemblyRef.MetroFrameworkDesignTestsIVT)]
...
namespace MetroFramework
{
    public static class AssemblyRef
    {
        ...
        internal const string MetroFrameworkTests_ = "MetroFramework.Tests";

        internal const string MetroFrameworkTestsIVT = "MetroFramework.Tests, PublicKey=" + MetroFrameworkKeyFull;

        internal const string MetroFrameworkDesignTests_ = "MetroFramework.Design.Tests";

        internal const string MetroFrameworkDesignTestsIVT = "MetroFramework.Design.Tests, PublicKey=" + MetroFrameworkKeyFull;

        internal const string MetroFrameworkFontsTests_ = "MetroFramework.Fonts.Tests";

        internal const string MetroFrameworkFontsTestsIVT = "MetroFramework.Fonts.Tests, PublicKey=" + MetroFrameworkKeyFull;
